...
The published release is **`v0.13.0`**; `main` tip is **`0.13.4`** (settings action UX / agent entry). Upstream evaluation: [`docs/DECISIONS.md`](docs/DECISIONS.md) §1 (Traditional Chinese).

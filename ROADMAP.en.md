...
Updated: 2026-08-02
Planning baseline: `v0.13.3` (`main` tip; published Release tag `v0.13.0`; upstream eval in [`docs/DECISIONS.md`](docs/DECISIONS.md) §1)
...
Review baseline: `v0.13.3` / `main`; GitHub Latest Release: `v0.13.0`

No known open P0/P1. `v0.13.0` is Latest. Upstream open PR/issues evaluated (nothing to merge; see [`docs/DECISIONS.md`](docs/DECISIONS.md) §1). Roadmap focus is **v0.14**. `main` tip `0.13.3` is documentation consolidation (no extra tag).

- Latest Release: `v0.13.0`; `main` tip docs are `0.13.x`.
...
- Settings schema 8; catalog CRUD / overlay lifecycle extracted; Idle once has clip cache and finish-timeout fallback.

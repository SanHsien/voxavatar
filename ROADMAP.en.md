...
Updated: 2026-08-02
Planning baseline: `0.16.3` (`main`; GitHub Latest Release tag remains `v0.16.0`; upstream eval in [`docs/DECISIONS.md`](docs/DECISIONS.md) §1)
...
Review baseline: `0.16.3` / `main`; GitHub Latest Release: `v0.16.0`

No known open P0/P1. Upstream open PR/issues evaluated (nothing to merge; see [`docs/DECISIONS.md`](docs/DECISIONS.md) §1). **No new features this round**—close existing gaps. `main` tip `0.16.3`: create form sits next to the action list.

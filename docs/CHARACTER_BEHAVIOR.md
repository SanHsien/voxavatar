...
Settings 動作列表另提供人工管理：預覽、顯示名稱、用途、排序、刪除、移至其他動作（磁碟仍為 UUID）。詳見 [`DECISIONS.md`](DECISIONS.md) §3／§10／§12。
...
- Settings 狀態槽／品質門檻／語音模式與氣泡錨點有 jsdom 互動測；目錄／action-pack partial failure 有可見 notice。

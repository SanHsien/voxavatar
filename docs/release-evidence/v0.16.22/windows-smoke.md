# Windows smoke evidence — v0.16.22
...
- version: `0.16.22`
- tag: `v0.16.22`
- commit: `892002118cbec6160515e38a55079743f5c5bb25`
- release URL: https://github.com/SanHsien/voxavatar/releases/tag/v0.16.22
- has installer cut: `true`

## Assets / signing

- installer: `VoxAvatar-0.16.22-windows-x64-setup.exe`
- size bytes: `105138140`
- sha256: `7a3b5aaf1c132ea7b89421cb2bd3e89313b9e82190b8c29ce2434f5596c06ac9`
- unsigned: `true`
...
installer Release v0.16.22（待機與說話動作輪播修正）; SHA-256 已下載比對相符; Authenticode NotSigned（PowerShell 與 PE Certificate Table 兩路一致）; 動作輪播實機 smoke 未驗

# Windows smoke evidence — v0.16.23
...
- version: `0.16.23`
- tag: `v0.16.23`
- commit: `d9b468bcb383849286051f9a944c0ac1a4a53379`
- release URL: https://github.com/SanHsien/voxavatar/releases/tag/v0.16.23
- has installer cut: `true`

## Assets / signing

- installer: `VoxAvatar-0.16.23-windows-x64-setup.exe`
- size bytes: `105138561`
- sha256: `6f222548173804c0169e385d7dc6c94a8dd962951b76054daf88ad9e8dac420a`
- unsigned: `true`
...
installer Release v0.16.23（動作洗牌輪播）; SHA-256 已下載比對相符; Authenticode NotSigned（PowerShell 與 PE Certificate Table 兩路一致）; 輪播實機 smoke 未驗
